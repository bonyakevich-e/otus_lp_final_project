...
rsync -Aavx -e "ssh -o StrictHostKeyChecking=no" root@192.168.56.30:/storage/webserver/nextcloud /backup/nextcloud/nextcloud-dirbkp_${log_date}/

#copy nextcloud database
mysqldump --single-transaction --default-character-set=utf8mb4 -h 192.168.56.40 -u'backup' -p'!Otus2024' nextcloud > /backup/nextcloud/nextcloud-sqlbkp_${log_date}.bak
